    ...
    {{
        ...
        "questions": [
            {{
                ...
                "correct_answer": "Índice da resposta correta (0-3)",
...
def analyze_content_difficulty(text: str) -> Dict[str, float]:
    """
    ...
    {{
        "adequação_11_12_anos": 0.8,  // Score de 0.0 a 1.0
        "adequação_13_14_anos": 0.9,
        "adequação_15_17_anos": 0.95,
        "vocabulário_complexidade": "médio",  // baixo, médio, alto
        "conceitos_abstratos": "médio",       // baixo, médio, alto
        "explicações_visuais": "alto",        // baixo, médio, alto
    ...
    try:
        ...
        return {
            ...
            "adequação_13_14_anos": 0.5,
            "adequação_15_17_anos": 0.5,
            "vocabulário_complexidade": "médio",
            "conceitos_abstratos": "médio",
            "explicações_visuais": "médio",
            "sugestões_adaptação": ["Não foi possível analisar devido a um erro."]
        }
